...
/// Predefined color palettes for the Orb
class OrbPalette {
  static const List<Color> siriOriginal = [
  ...
  static const List<Color> inferno = [
    Colors.redAccent,
    Colors.deepOrange,
    Colors.amber,
    Colors.yellowAccent,
...
/// A controller used to dynamically adjust the amplitude of the Orb
/// without triggering a full screen rebuild.
class OrbController extends ChangeNotifier {
  double _amplitude;

  OrbController({double initialAmplitude = 0.0})
